<!-- begin page 1 -->
<div data-background-image="{{ asset('asset/img/Pertamina Siap Wujudkan Kemandirian Energi_Divider.jpg') }}" class="book-page-{{ $page }}">
    ...
    <div class="fb5-cont-page-book">
        ...
        <div class="fb5-page-book">
            <div class="main page-template-18">
                    ...
                    <div class="page-body">
                        ...
                        <div class="flex-item-container">
                            <p class="content-text left-area highlight-text-content">
                                ...
                                kemandirian energi negeri, Pemerintah melalui Komite Percepatan
                                Penyediaan Infrastruktur Prioritas (KPPIP) mendorong kegiatan Proyek
                                Strategis Nasional (PSN) agar segera terselesaikan. PSN merupakan
