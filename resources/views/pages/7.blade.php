...
<div data-background-image="" class="book-page-{{ $page }}">
    ...
    <div class="fb5-cont-page-book">
        ...
        <div class="fb5-page-book">
            <div class="main page-template-22">
                            ...
                            <div class="flex-container">
                                ...
                                <div class="item-container">
                                    <div class="image-container">
                                        <img src="{{ asset('asset/img/Asset 5.png') }}" alt=""
                                            class="content-image">
                                    </div>
                                    <div class="text-container">
                                        <h3 class="people-name highlight-text-content">
                                            Rohmadi
                                        </h3>
                                        <p class="people-job-title highlight-text-content">
                                ...
                                <div class="item-container">
                                    <div class="image-container">
                                        <img src="{{ asset('asset/img/Asset 6.png') }}" alt=""
                                            class="content-image">
                                    </div>
                                    <div class="text-container">
                                        <h3 class="people-name highlight-text-content">
                                ...
                                <div class="item-container">
                                    <div class="image-container">
                                        <img src="{{ asset('asset/img/Asset 7.png') }}" alt=""
                                            class="content-image">
                                    </div>
                                    <div class="text-container">
                                        <h3 class="people-name highlight-text-content">
                                ...
                                <div class="item-container">
                                    <div class="image-container">
                                        <img src="{{ asset('asset/img/Asset 8.png') }}" alt=""
                                            class="content-image">
                                    </div>
                                    <div class="text-container">
                                        <h3 class="people-name highlight-text-content">
                                ...
                                <div class="item-container">
                                    <div class="image-container">
                                        <img src="{{ asset('asset/img/Syarifah PNG.png') }}" alt=""
                                            class="content-image">
                                    </div>
                                    <div class="text-container">
                                        <h3 class="people-name highlight-text-content">
                                ...
                                <div class="item-container">
                                    <div class="image-container">
                                        <img src="{{ asset('asset/img/Asset 10.png') }}" alt=""
                                            class="content-image">
                                    </div>
                                    <div class="text-container">
                                        <h3 class="people-name highlight-text-content">
                                ...
                                <div class="item-container">
                                    <div class="image-container">
                                        <img src="{{ asset('asset/img/Asset 11.png') }}" alt=""
                                            class="content-image">
                                    </div>
                                    <div class="text-container">
                                        <h3 class="people-name highlight-text-content">
                                ...
                                <div class="item-container">
                                    <div class="image-container">
                                        <img src="{{ asset('asset/img/Asset 13.png') }}" alt=""
                                            class="content-image">
                                    </div>
                                    <div class="text-container">
                                        <h3 class="people-name highlight-text-content">
